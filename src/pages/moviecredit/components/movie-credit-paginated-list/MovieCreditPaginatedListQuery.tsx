...
import {PaginatedMovieCreditDetailsSchema} from "@/pages/moviecredit/schemas/model/movie-credit-related-schema/MovieCreditRelated.schema.ts";
import {PaginatedMovieCreditDetails} from "@/pages/moviecredit/schemas/model/movie-credit-related-schema/MovieCreditRelated.types.ts";
...
const MovieCreditPaginatedListQuery = (props: QueryProps) => {
    ...
    return (
        <ValidatedDataLoader query={query} schema={PaginatedMovieCreditDetailsSchema}>
