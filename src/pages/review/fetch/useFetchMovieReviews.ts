...
import {MovieReviewQueryOptions} from "@/pages/review/schemas/options/MovieReviewQueryOptionsSchema.ts";
import {useQuery, UseQueryResult} from "@tanstack/react-query";
import HttpResponseError from "@/common/errors/HttpResponseError.ts";
import useQueryFnHandler from "@/common/utility/query/useQueryFnHandler.ts";
import {MovieReviewCRUDRepository} from "@/pages/review/repositories/MovieReviewCRUDRepository.ts";
...
export function useFetchMovieReviews(
    ...
    return useQuery({
        queryKey: ["movie_reviews", "lists", "query", {...queries, ...config}],
