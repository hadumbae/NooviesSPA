...
import useTheatreSubmitForm from "@/pages/theatres/hooks/useTheatreSubmitForm.ts";
import useTheatreSubmitMutation from "@/pages/theatres/hooks/useTheatreSubmitMutation.ts";
