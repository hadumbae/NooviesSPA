 ...
 */
export const ISO3166Alpha2CodeEnum = z.enum(ISO3166Alpha2CodeConstant, {message: "Invalid Country."});

/**
 * Type alias for the inferred TypeScript union of valid ISO 3166-1 alpha-2 codes.
 *
 * This type represents all allowed string literals defined in `ISO3166Alpha2CodeEnum`.
 *
 * @example
 * const country: ISO3166Alpha2Code = "CA"; // ✅
 * const country: ISO3166Alpha2Code = "XX"; // ❌ Type error
 */
export type ISO3166Alpha2Code = z.infer<typeof ISO3166Alpha2CodeEnum>;