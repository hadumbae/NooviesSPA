 ...
 */
export const ISO6391CodeEnum = z.enum(ISO6391CodeConstant, {message: "Invalid Language"});

/**
 * Type alias for the inferred TypeScript union of valid ISO 639-1 codes.
 *
 * This type will be a union of string literals based on the values in `ISO6391CodeEnum`.
 *
 * @example
