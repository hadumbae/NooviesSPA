...
import {CoordinateFormSchema, CoordinateFormValueSchema} from "@/common/schema/models/coordinate-form/CoordinateForm.schema.ts";
...
export const LocationFormValueSchema = z.object({
    ...
    includeCoordinates: CoercedBooleanValueSchema,
