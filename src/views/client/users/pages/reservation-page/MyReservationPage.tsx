/**
 * @fileoverview Reservation detail page container that fetches data based on route parameters.
 */
...
} from "@/views/client/users/pages/reservation-page/MyReservationPageContent.tsx";
...
/**
 * Page component that fetches and displays a specific reservation using its slug.
 */
