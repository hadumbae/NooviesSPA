...
import ShowingMovieCard from "@/views/admin/showings/_comp/showing-movie-card/ShowingMovieCard.tsx";
import {
    ShowingSummaryCardList
} from "@/views/admin/showings/_comp/showing-summary-card/ShowingSummaryCardList.tsx";
