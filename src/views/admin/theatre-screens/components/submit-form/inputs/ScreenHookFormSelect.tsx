...
import useFetchScreens from "@/domains/theatre-screens/hooks/screens/fetch-screens/useFetchScreens.ts";
...
const ScreenHookFormSelect = <TSubmit extends FieldValues>(
    ...
    return (
        <ValidatedDataLoader query={query} schema={TheatreScreenArraySchema} loaderComponent={Loader}>
            {(screens: TheatreScreenArray) => {
