...
import {PersonDetailsPageActions} from "@/views/admin/persons/details-page/sections/actions.tsx";
import {PersonDetailsPageHeader} from '@/views/admin/persons/details-page/sections/header.tsx';
