...
import PersonDetailsBreadcrumbs from "@/views/admin/persons/pages/details-page/PersonDetailsBreadcrumbs.tsx";
import PersonDetailsHeader from "@/views/admin/persons/pages/details-page/PersonDetailsHeader.tsx";
