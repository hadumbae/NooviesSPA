...
import {
    ReservationBase
} from "@/domains/reservation/schema/model/reservation/Reservation.types.ts";
import {ReservationStatus} from "@/domains/reservation/schema/enum/ReservationStatusEnumSchema.ts";
import {ReservationDetailsBase} from "@/domains/reservation/schema/model/reservation/ReservationDetails.types.ts";
