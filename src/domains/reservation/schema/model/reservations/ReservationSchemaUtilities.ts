...
import {ReservationBase} from "@/domains/reservation/schema/model/reservations/ReservationBaseSchema.ts";
import {PopulatedReservationBase} from "@/domains/reservation/schema/model/populated-reservations/PopulatedReservationBaseSchema.ts";
import {AdminReservationBase} from "@/domains/reservation/schema/model/admin-reservations/AdminReservationBaseSchema.ts";
