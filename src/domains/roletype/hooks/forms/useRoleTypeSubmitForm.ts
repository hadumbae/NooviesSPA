import {RoleTypeFormValues} from "@/domains/roletype/schema/submit-form/RoleTypeForm.types.ts";
...
import {RoleTypeFormSchema} from "@/domains/roletype/schema/submit-form/RoleTypeForm.schema.ts";
...
export default function useRoleTypeSubmitForm(params?: FormParams): UseFormReturn {
    ...
    const defaultValues: RoleTypeFormValues = {
        ...
        department: getDefaultValue(presetValues?.department, roleType?.department, undefined),
        category: getDefaultValue(presetValues?.category, roleType?.category, undefined),
