...
import {SeatMapDetails, SeatMapDetailsSchema} from "@/domains/seatmap/_schema/model/SeatMapDetailsSchema";
import {SeatMapCRUDMutationKeys, SeatMapCRUDQueryKeys} from "@/domains/seatmap/_feat/crud-hooks/keys";
import {create, update} from "@/domains/seatmap/_feat/crud";
import {SeatMapFormData} from "@/domains/seatmap/_feat/submit-data";
