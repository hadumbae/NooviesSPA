import useSeatMapUpdateAvailabilityMutation from "@/domains/seatmap/hooks/mutations/useSeatMapUpdateAvailabilityMutation.ts";
import useSeatMapDeleteMutation from "@/domains/seatmap/hooks/mutations/useSeatMapDeleteMutation.ts";
