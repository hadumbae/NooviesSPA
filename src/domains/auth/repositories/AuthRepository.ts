...
import {AuthRegisterForm} from "@/domains/auth/schema/form/AuthRegisterForm.types.ts";
import {AuthLoginForm} from "@/domains/auth/schema/form/AuthLoginForm.types.ts";
import {AuthRepositoryMethods} from "@/domains/auth/repositories/AuthRepository.types.ts";
