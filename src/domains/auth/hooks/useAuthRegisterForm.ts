...
import {AuthRegisterFormSchema} from "@/domains/auth/schema/form/AuthRegisterForm.schema.ts";
import {AuthRegisterFormValues} from "@/domains/auth/schema/form/AuthRegisterForm.types.ts";
