...
import PersonRepository from "@/domains/persons/repositories/PersonRepository.ts";
...
import {PersonQueryKeys} from "@/domains/persons/utiliities/query/PersonQueryKeys.ts";
